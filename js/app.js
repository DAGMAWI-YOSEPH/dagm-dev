const App = (() => {
  const SOCIAL_ICONS = {
    ...
    letterboxd: '<svg viewBox="0 0 24 24"><path d="M8.224 14.352a4.773 4.773 0 0 1-3.758-4.278 4.775 4.775 0 0 1 3.758-4.278A4.775 4.775 0 0 0 6.4 2.4C3.306 2.4.8 5.706.8 9.6s2.506 7.2 5.6 7.2c.634 0 1.245-.112 1.824-.32a4.773 4.773 0 0 1 0-2.128zM12 5.796a4.773 4.773 0 0 1 0 7.608 4.773 4.773 0 0 0 0-7.608zm3.776 8.556a4.773 4.773 0 0 0 3.758-4.278 4.775 4.775 0 0 0-3.758-4.278c.579-.208 1.19-.32 1.824-.32 3.094 0 5.6 3.306 5.6 7.2s-2.506 7.2-5.6 7.2c-.634 0-1.245-.112-1.824-.32z"/></svg>',
