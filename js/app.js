const App = (() => {
  ...
  function populateSite(data) {
    ...
    document.getElementById('hero-bio').textContent = data.meta.bio;
  ...
  function initAnimations() {
    ...
    gsap.from('.hero-bio', { opacity: 0, y: 20, duration: 0.6, delay: 0.7 });
    gsap.from('.hero-status', { opacity: 0, y: 15, duration: 0.5, delay: 0.8 });
    gsap.from('.hero-actions', { opacity: 0, y: 15, duration: 0.5, delay: 0.9 });
    ...
    gsap.from('.quick-link', {
      ...
      duration: 0.4,
      stagger: 0.08,
      scrollTrigger: { trigger: '.quick-links', start: 'top 90%' }
    });
